...
from src.youtube_mcp import youtube

# Test get_video_info
@patch('src.youtube_mcp.google_api.yt_get_video_info')
...
@patch('src.youtube_mcp.google_api.yt_get_video_info', side_effect=Exception('API error'))
def test_get_video_info_error(mock_yt_get_video_info):
    result = youtube.get_video_info('fake_api_key', 'fake_video_id')
    assert result is None

# Test get_video_transcript - Updated for yt-ts-extract
@patch('src.youtube_mcp.transcript_api.get_transcript')
@patch('src.youtube_mcp.transcript_api.get_transcript_text')
@patch('src.youtube_mcp.transcript_api.get_available_languages')
@patch('src.youtube_mcp.transcript_api.YouTubeTranscriptExtractor')
